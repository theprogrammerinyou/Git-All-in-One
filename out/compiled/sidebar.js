var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "Merge";
    			t2 = space();
    			button1 = element("button");
    			button1.textContent = "Revert Commit";
    			t4 = space();
    			button2 = element("button");
    			button2.textContent = "Push To Remote";
    			t6 = space();
    			button3 = element("button");
    			button3.textContent = "Info";
    			t8 = space();
    			button4 = element("button");
    			button4.textContent = "Erro";
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Commit Message");
    			add_location(input, file, 3, 0, 43);
    			add_location(button0, file, 5, 0, 95);
    			add_location(button1, file, 9, 0, 197);
    			add_location(button2, file, 13, 0, 315);
    			add_location(button3, file, 17, 0, 423);
    			add_location(button4, file, 21, 0, 531);
    		},
    ...
    function instance($$self, $$props) {
    	...
    	const click_handler = () => {
    		tsvscode.postMessage({ type: "merge", value: "merge" });
    	};

    	const click_handler_1 = () => {
    		tsvscode.postMessage({ type: "revertCommit", value: "revert" });
    	};

    	const click_handler_2 = () => {
    		tsvscode.postMessage({ type: "push", value: "push" });
    	};

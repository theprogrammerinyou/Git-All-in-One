...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("gitAllInOne-sidebar", sidebarProvider));
    context.subscriptions.push(vscode.commands.registerCommand("gitAllInOne.helloWorld", () => {
        ...
        webviewView.webview.onDidReceiveMessage((data) => __awaiter(this, void 0, void 0, function* () {
            switch (data.type) {
                ...
                case "merge": {
                    ...
                    const merged = yield vscode.commands.executeCommand("git.merge");
                    if (merged) {
                ...
                case "revertCommit": {
                    ...
                    const reverted = yield vscode.commands.executeCommand("git.revertCommit");
                    if (reverted) {
